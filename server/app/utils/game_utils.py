...
SYNTAX_ERROR_PENALTIES = {
    ...
    SyntaxErrorType.ENUMERATION_TYPE_WITH_ATTRIBUTES: ErrorWeight.MEDIUM_HIGH,
    SyntaxErrorType.CLASS_AS_ATTRIBUTE_TYPE: ErrorWeight.HIGH,
    SyntaxErrorType.UNCONNECTED_ENUMERATION: ErrorWeight.MEDIUM_LOW,
    SyntaxErrorType.INVALID_INTERMEDIATE_CLASS_CONNECTIONS: ErrorWeight.MEDIUM_HIGH
}
...
SEMANTIC_ERROR_PENALTIES = {
    ...
    SemanticErrorType.CLASS_TYPE: ErrorWeight.HIGH
}
